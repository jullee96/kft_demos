This document is a declaration of software quality for the `kft_demos_dashboard_resources` package, based on the guidelines in [REP-2004](https://www.ros.org/reps/rep-2004.html).
