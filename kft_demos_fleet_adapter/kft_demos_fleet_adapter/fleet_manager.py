...
class FleetManager(Node):
    def __init__(self, config, nav_path):
        ...
        @app.get('/open-rmf/kft_demos_fm/status/',
        ...
        @app.post('/open-rmf/kft_demos_fm/navigate/',
                  response_model=Response)
        ...
        @app.get('/open-rmf/kft_demos_fm/stop_robot/',
                 response_model=Response)
        ...
        @app.post('/open-rmf/kft_demos_fm/start_task/',
                  response_model=Response)
        ...
        @app.post('/open-rmf/kft_demos_fm/toggle_action/',
                  response_model=Response)
