...
package_name = 'kft_demos_panel'
py_version = ".".join(map(str, sys.version_info[:2]))
site_pkgs_path = 'lib/python' + py_version + '/site-packages/kft_demos_panel'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'simple_api_server=kft_demos_panel.simple_api_server:main',
        ],
    },
)
