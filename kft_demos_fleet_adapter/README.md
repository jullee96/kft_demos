...
You can interact with the endpoints with FastAPI's automatic documentation. First launch a demo world, then visit the base URL with `/docs` appended at the end. Do take note that the port number for each demo fleet is specified in `kft_demos/kft_demos/config/`.
...
Request URL: `http://127.0.0.1:22011/open-rmf/kft_demos_fm/status/`
##### Response Body:
```json
{
  "data": {
...
Request URL: `http://127.0.0.1:22011/open-rmf/kft_demos_fm/status/?robot_name=tinyRobot1`
##### Response Body:
```json
{
  "data": {
...
Request URL: `http://127.0.0.1:22011/open-rmf/kft_demos_fm/navigate/?robot_name=tinyRobot1`
##### Request Body:
```json
{
  "map_name": "L1",
...
Request URL: `http://127.0.0.1:22011/open-rmf/kft_demos_fm/stop/?robot_name=tinyRobot1`
##### Response Body:
```json
{
  "success": true,
...
Request URL: `http://127.0.0.1:22011/open-rmf/kft_demos_fm/start_task/?robot_name=tinyRobot1`
##### Request Body:
```json
{
  "map_name": "L1",
